...
public class P4Movement1Activity extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intValue) {
            case 1:
                setContentView(R.layout.activity_sport_bir4);
                break;
            case 2:
                setContentView(R.layout.activity_sport_iki4);
                break;
            case 3:
                setContentView(R.layout.activity_sport_uc4);
                break;
            case 4:
                setContentView(R.layout.activity_sport_dort4);
                break;
            case 5:
                setContentView(R.layout.activity_sport_bes4);
                break;
            case 6:
                setContentView(R.layout.activity_sport_alti4);
                break;
            case 7:
                setContentView(R.layout.activity_sport_yedi4);
                break;
            case 8:
                setContentView(R.layout.activity_sport_sekiz4);
                break;
            case 9:
                setContentView(R.layout.activity_sport_dokuz4);
                break;
            case 10:
                setContentView(R.layout.activity_sport_on4);
                break;
        }

        //setContentView(R.layout.activity_p4_movement1);
        MTimeRunning = false;
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(MTimeLeftinmillis, 1000) {
            ...
            public void onFinish() {
                ...
                if (newValue <= 10) {
                    Intent intent = new Intent(P4Movement1Activity.this, P4Movement1Activity.class);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(P4Movement1Activity.this);
                    ...
                    okButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(P4Movement1Activity.this, SportsExerciseActivity.class);
