...
public class P4SportActivity extends AppCompatActivity {
    int[] newArray;
    ...
    public void ImageButtonClicked(View view) {
        for(int i=0;i<newArray.length;i++){
            if(view.getId()==newArray[i]){
                ...
                Intent intent=new Intent(P4SportActivity.this,P4Movement1Activity.class);
